...
- Email: [lukas.skarpa.bata@gmail.com](mailto:lukas.skarpa.bata@gmail.com)
- Location: Pitín 32, Zlínský kraj, Czech Republic
- GitHub: [lukasskarpa](https://github.com/lukasskarpa)
...
# Education
## **GJP a SOŠ Slavičín**, Information Technology / Computer Science
...
# Experience
## **Bata (Freelance Contract, via internship placement)**, Freelance Web Developer

Remote / Zlín, Czech Republic
...
## **Bata Zlín MDC**, Web Development Intern
...
# Skills
**Web Development (Frontend):** HTML & CSS/SCSS (advanced layout and styling), JavaScript & React (building interactive, production-grade web applications)

**Programming & Logic:** Python (scripting and core logic)

**Development Tools:** Git (version control across team projects), Jira & Confluence (professional project management and documentation)

**Languages:** English — Cambridge B2 Certified
