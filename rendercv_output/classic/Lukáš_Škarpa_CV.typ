...
#connections(
  [#connection-with-icon("location-dot")[Pitín 32, Zlínský kraj, Czech Republic]],
  [#link("mailto:lukas.skarpa.bata@gmail.com", icon: false, if-underline: false, if-color: false)[#connection-with-icon("envelope")[lukas.skarpa.bata\@gmail.com]]],
  [#link("tel:+420-737-117-624", icon: false, if-underline: false, if-color: false)[#connection-with-icon("phone")[737 117 624]]],
  [#link("https://github.com/lukasskarpa", icon: false, if-underline: false, if-color: false)[#connection-with-icon("github")[lukasskarpa]]],
)
...
#education-entry(
  [
    #strong[GJP a SOŠ Slavičín], Information Technology \/ Computer Science
...
#regular-entry(
  [
    #strong[Bata (Freelance Contract, via internship placement)], Freelance Web Developer
...
#regular-entry(
  [
    #strong[Bata Zlín MDC], Web Development Intern
